...
classifier = nltk.MaxentClassifier.train(train_set, algorithm="iis", max_iter=5) #'iis'=Improved Iterative Scale
...
print('Precision for Logistic Regression is : ', precision, '(neg // pos)')
print('Recall for Logistic Regression is : ',recall, '(neg // pos)')
print('F-measure for Logistic Regression is : ',fscore, '(neg // pos)''\n')

precision, recall, fscore, support = score(y_true, y_predicted, average='weighted')

print('Weighted Precision for Logistic Regression is : ', precision)
print('Weighted Recall for Logistic Regression is : ',recall)
print('Weighted F-measure for Logistic Regression is : ',fscore, '\n')
